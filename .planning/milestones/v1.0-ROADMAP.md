...
Plans:
- [x] 02-01-PLAN.md — Wave 0: payload 스키마 + 에이전트 시스템 프롬프트 4개 + 테스트 stub 8개 (ORCH-02, ORCH-03)
- [x] 02-02-PLAN.md — TaskGraph (DAG) + MessageRouter broadcast 복사 (ORCH-05, WKFL-01, WKFL-03, WKFL-04)
- [x] 02-03-PLAN.md — OrchestrationLoop 상태 머신 + QA 게이트 (ORCH-01, ORCH-04, WKFL-02)
- [x] 02-04-PLAN.md — FastAPI POST /api/tasks 통합 + 에이전트 프롬프트 테스트 GREEN (전체 요구사항)
- [ ] 02-05-PLAN.md — [gap closure] server/agents/ 협업 규칙 보완 + loop.py AGENTS_DIR 경로 통합 (ORCH-02)
...
Plans:
- [ ] 04-01-PLAN.md — FastAPI 누락 API 4개 추가: GET /api/tasks, 워크스페이스 파일 API, DAG API (DASH-04, DASH-05, WKFL-05)
- [ ] 04-02-PLAN.md — Vite + React 19 + Tailwind v4 스캐폴드 + TypeScript 공유 타입 (DASH-01~05, WKFL-05)
- [ ] 04-03-PLAN.md — zustand 스토어 3개 + useLogSocket 훅 (DASH-02, DASH-03, DASH-05)
- [ ] 04-04-PLAN.md — TaskInputPanel + TaskList + API 클라이언트 (DASH-01, DASH-05)
- [ ] 04-05-PLAN.md — AgentStatusBoard + LogStreamPanel (DASH-02, DASH-03)
- [ ] 04-06-PLAN.md — DagView (@xyflow/react) + ArtifactViewer (shiki + react-markdown) (DASH-04, WKFL-05)
- [ ] 04-07-PLAN.md — AppShell 레이아웃 조립 + 다크/라이트 모드 + 사람 확인 (DASH-01~05, WKFL-05)
