    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-10">
      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4
          ...
          <h2 className="text-base font-semibold">리액션 통계 (최근 30일)</h2>
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto">
          {isLoading && <p className="text-sm text-gray-400 text-center py-8">로딩 중...</p>}

          {!isLoading && Object.keys(totals).length === 0 && (
            <p className="text-sm text-gray-400 text-center py-8">아직 리액션이 없습니다</p>
          )}
                  ...
                  {AGENT_IDS.map((agentId) => {
                    ...
                    return (
                      <div key={agentId}
                        ...
                        <span className="text-sm font-medium">{displayName(agentId)}</span>
